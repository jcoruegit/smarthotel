...
import { changePassword, getCurrentEmployeeProfile, getDocumentTypes, updateCurrentEmployeeProfile } from '../../auth/api/authApi';
    ...
    async function loadData() {
      ...
      try {
        const [options, profile] = await Promise.all([
          getDocumentTypes(),
          getCurrentEmployeeProfile(accessTokenValue),
        ]);
  ...
  return (
    <main className="page staff-page">
      <header className="section-header">
        ...
        <p className="subtle">Actualiza tu informacion personal y tu clave de acceso.</p>
      </header>
